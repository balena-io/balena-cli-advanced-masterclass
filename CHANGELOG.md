...
* Update README with advanced CLI masterclass reference [Matthew Yarmolinsky]
...
* Reworked this guide and verified the steps and output from each step and brought over to flowzone [Ryan H]
...
* Update incorrect link to Fin dev kit [Jasmine Gilbert]
